        ...
        <div className="page__content">
          <div className="main-block">
            ...
            <div className="page__information info">
                        <div className="info__header">Вместе с <span className="info__highlight">БЕСПЛАТНОЙ КОНСУЛЬТАЦИЕЙ</span> мы дарим:</div>
                        ...
                        <form className="info__btn btn">
                            <button className="btn__get-consultation">Получить консультацию</button>
                        </form>
                    </div>
